<?php
$show_brands = funio_get_config('show-brands',true);
do_action( 'before' );
if ( $list -> have_posts() ){ ?>
	<div id="<?php echo $widget_id; ?>" class="bwp-countdown <?php echo esc_attr($layout); ?> <?php echo esc_attr($class); ?> <?php if(empty($title1)) echo 'no-title'; ?>">       
		...
		<div class="content-product-list">	
			...
			<?php while($list->have_posts()): $list->the_post();?>
				...
				$product_hot_label = isset($funio_settings['product-hot-label']) && !empty($funio_settings['product-hot-label']) ? $funio_settings['product-hot-label'] : esc_html__('Hot','wpbingo');
				$product_sale_label = funio_get_product_discount();
				$product_sale = funio_get_config('product-sale',true);
					...
					<div class="item-product-content products-entry clearfix product-wapper">
						<div class="grid-content">
							...
							<div class="products-content">
								...
								<?php if($show_brands){ funio_get_brans() ;} ?>
