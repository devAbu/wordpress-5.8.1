...
( function( $ ) {
	...
	function _after_add_to_cart(){
		$( _body ).on( 'added_to_cart', function(){
			_click_add_to_cart();
			$('body').append('<div class="funio-product-added"><div class="added-message">'+$(".mini-cart").data("text_added")+'</div>');
			setTimeout(function(){
	...
	function _click_add_to_cart(){
		...
		$(".cart-icon").on( "click", function() {
			if( !_body.hasClass("not-scroll") && $(".funio-topcart").hasClass("popup") ){
