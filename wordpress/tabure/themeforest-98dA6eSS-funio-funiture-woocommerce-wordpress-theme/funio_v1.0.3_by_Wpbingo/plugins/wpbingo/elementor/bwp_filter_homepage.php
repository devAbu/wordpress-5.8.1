		...
		$this->add_control(
			...
			[
				...
				'condition'   => [
					...
					"tab_product_slider_4","tab_product_slider_5","tab_category_slider_3","tab_category_slider_4","tab_category_icon","tab_category_scroll"],
                ]				
			]
		);
		$this->add_control(
		...
		$this->add_control(
			...
			[
				...
				'condition'   => [
					...
					"tab_category_slider_5","tab_category_icon","tab_category_scroll"],
                ]				
			]
		);
		$this->add_control(
			...
			[
				...
				'condition'   => [
					...
					"tab_category_slider_4","tab_category_slider_5","tab_category_icon","tab_category_scroll"],
                ]				
			]
		);		
		$this->add_control(
